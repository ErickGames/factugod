...
<body style="background: rgb(156,154,154); background: linear-gradient(0deg, rgba(156,154,154,1) 30%, rgba(44,27,79,1) 30%, rgba(44,27,79,1) 94%, rgba(34,18,61,1) 100%); overflow-x: hidden; ">
    ...
    <div class="formresp">
        ...
        <form action="../includes/correo3.php" method="POST">
            <div>
            ...
            <div>
                <h3 style="text-align:center; font-family:tit">Mas información</h3>
                <h6 style="text-align:center; font-family:tit; margin-left:40px; margin-right:40px">Solicita más informacion sobre los planes, se enviará un correo con
            información deteallada de cada uno de éstos. <br><br> Favor de lleanr los siguientes campos:</h6>
                <br>
            </div>
            ...
            <div class="row" style="text-align:left; margin-top:15px">
                ...
                <div class="col-md-6">
                    <label class="form-label" style="font-size:15px ;" for="">EMPRESA:</label>
            ...
            <div class="row" style="text-align:left; margin-top:15px">
                ...
                <div class="col-md-6">
                    <label class="form-label" style="font-size:15px ;" for="">TELÉFONO<span style="color:red">*</span></label>
            ...
            <div class="text-center">
                <button type="submit" target="_blank" class="btn btn-primary" style="background-color:#482c7c; border-color:#482c7c">Aceptar</button>
            </div>
